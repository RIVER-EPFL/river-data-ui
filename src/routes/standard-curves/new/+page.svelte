<script lang="ts">
	...
	const fields: Field[] = $derived([
		...
		{ key: 'created_by', label: 'Created By', helperText: 'Who created this calibration curve' },
	]);
</script>

<svelte:head><title>New Standard Curve | River Data</title></svelte:head>

<CrudForm client={api.standardCurves} title="New Standard Curve" backHref="{base}/standard-curves" {fields} />
