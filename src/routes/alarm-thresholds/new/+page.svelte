...
<svelte:head><title>New Threshold | River Data</title></svelte:head>

<CrudForm client={api.alarmThresholds} title="New Alarm Threshold" backHref="{base}/alarm-thresholds" {fields} />
