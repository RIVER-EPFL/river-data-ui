<script lang="ts">
	...
	const fields: Field[] = $derived([
		...
		{ key: 'valid_from', label: 'Valid From', type: 'datetime', required: true, helperText: 'Start of calibration validity period. The end is derived from the next curve on the channel; edit the curve afterwards to set it by hand' },
