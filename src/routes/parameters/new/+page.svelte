...
<CrudForm
	...
	fields={[
		...
		{ key: 'name', label: 'Name', required: true, derivedFrom: 'code', helperText: 'Human label shown in the UI, e.g. Dissolved Oxygen. Follows the code until you type one of your own.' },
